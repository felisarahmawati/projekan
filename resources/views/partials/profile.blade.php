   ...
   <div class="col" style="width: 400px">
    ...
    <div class="row" style="width: 300px">
        ...
        <div class="col-md-3">
            <p class="text-end"><a href="/user/Alamat"><i class="bi bi-chevron-right"></i></a></p>
        </div>   
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <p class="text-end"><a href="/user/kebijakanprivasi"><i class="bi bi-chevron-right"></i></a></p>
        </div>   
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <p class="text-end"><a href="/user/bantuan"><i class="bi bi-chevron-right"></i></a></p>
        </div>    
    </div>
    <div class="row">
        <div class="col-md">
        ...
        <div class="col-md-3">
            <p class="text-end"><a href="/user/tentang"><i class="bi bi-chevron-right"></i></a></p>
        </div>    
    </div>
