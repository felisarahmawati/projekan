    ...
    <div class="main">
        <div class="topbar">
            ...
            <div class="cardHeader-title">
                ...
                <div class="col-7 text-end">
                <button type="button" class="btn bg-white" data-bs-toggle="modal" data-bs-target="#exampleModal"> Pilih</button>
                <!-- Modal -->
                ...
                <button type="button" class="btn btn-success" data-bs-dismiss="modal">Pickup sendiri</button>
        ...
        </div><div class="modal fade" id="modalvendor" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header text-white bg-success">
       ...
       <span class="visually-hidden">Loading...</span>
        ...
        Tunggu sebentar ya. Sistem sedang mencari vendor pick up lain untuk mengatasi masalah anda
         ...
         <div class="d-grid gap-2 col-6 mx-auto">
         <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal5">Pickup sendiri</button><br>
          </div>
         </div>
         </div>
         </div>
        ...
        <button type="button" class="btn-close bg-white rounded" data-bs-dismiss="modal" aria-label="Close"></button>
         ...
         <div class="card-body text-center">
         <h6 class="berhasil" style="padding-top: 5px; color: grey">Hore!! Pesanan anda telah berhasil diterima oleh vendor lain, tunggu dulu yaa</h6>
        ...
        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal5">
                                        ...
                                        <div class="d-grid gap-2 col-6 mx-auto">
                                            <a href="/orderan_baru" data-bs-toggle="modal" data-bs-target="#exampleModal24" class="btn btn-success">Ambil pesanan</a>
                                            <a class="btn btn-outline-secondary" href="/orderan_baru" role="button">Tolak</a>
                                        </div>
                                        <!-- Modal -->
