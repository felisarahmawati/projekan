                            ...
                            <div class="card-body justify-content-center" style="margin-top: 10px; width:70%; margin:auto">
                                <div class="card mt-2 shadow rounded-3">
                                    ...
                                    <div class="col text-center">
                                        <img src="../assets/img/icon_kendaraan.png" class="img-fluid rounded" alt="..." style="width: 30%; height:30%; padding-top: 15px">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            ...
                                            <div class="d-grid gap-2 col-6 mx-auto">
                                                <a class="btn btn-outline-success" href="/rincian_baru" role="button">Detail</a>
                                            </div>
                                        </div>
                                    </div>
                                    </div>
