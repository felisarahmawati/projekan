                        ...
                        <div class="row p-4">
                            <div class=" col-md-8 card p-3">
                                <div class="row col-md-12">
                                    <div class="col-md-8" style="padding-left: 30px">
                                        <p class="mt-3" style="font-size:30px">Saldo</p>
                                        <p>$300.000</p>
                                    </div>
                            ...
                            <div class="col-md-4 ">
                                <div class="row col-md-12">
                                    <div class="row ">
                                        <div class="col-md-4">
                                          <img src="../../assets/img/mandiri.png" class="img-fluid rounded-start mt-5" alt="..." style="padding-left:15px; font-size:20px">
                                        </div>
                                        <div class="col-md-7">
                                          <div class="card-body" >
                                         <p style="font-size: 15px"><b>BANK MANDIRI</b>
                                        </p>
                                        ...
                                        <div class="col-md-1">
                                            <i class="bi bi-pencil-square mt-4" style="font-size:25px"></i>
                                        </div>
                                      </div>
                                </div>
                            </div>
