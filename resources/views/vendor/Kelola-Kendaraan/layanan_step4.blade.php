                            ...
                            <div class="card-body">
                                ...
                                <a href="/Vendor/Kelola-Kendaraan/"><i class="bi bi-arrow-left px-2 "></i><b>Kelola Kendaraan</b><hr></a>
                                    ...
                                    <div class="">
                                     ...
                                     <div class="row mb-5">
                                        <div class="col-md-10 ">
                                            <p class="ps-4">Menginputkan detail rincian lahan parkir</p>
                                        </div>
                                        <div class="col-md-2 mb-3">
                                            <i class="bi bi-check2-square" style="font-size: 37px; color:rgb(98, 212, 133);"></i>
                                        </div>   
                                    ...
                                    <a href="/Vendor/Kelola-Kendaraan/setelah_input"><button type="button" class="btn btn-success col-md-12 mt-3" data-bs-toggle="modal" data-bs-target="#exampleModalearning">Selanjutnya</button></a>
