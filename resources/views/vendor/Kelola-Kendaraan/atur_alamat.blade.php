...
<section class="align-items-center services section-bg"  id="services" style="padding-top: 100px;" data-aos-delay="50">
    <div class="">
        <div class="cardBox1">
            <div class="card2">
                <div>
                    <a href="Vendor/Kelola-barang/kelola_kendaraan" style="text-decoration:none">
                                   ...
                                   <a href="/Vendor/Kelola-Kendaraan/layanan_step1"><i class="bi bi-arrow-left px-2 "></i><b>Kelola Kendaraan</b><hr></a>
                                    ...
                                    <div>
                                     ...
                                     <div class="row text-muted">
                                        <div class="col-md-8 ">
                                            <p class="">Mengatur jenis kendaraan yang dititipkan</p>
                                        </div>
                                    ...
                                    <div class="text-muted">
                                     ...
                                     <div class="row">
                                        <div class="col-md-8 ">
                                            <p class="">Menginputkan detail 
                                                rincian lahan parkiran </p>
                                        </div>
                                        <div class="col-md-4">
                                        </div>   
                                     </div>
        ...
        <div class="col" style="width: 700px">
            <div class="card">
              <div class="card-body">
                ...
                <form action="">
                  <div class="mb-3">
                      <label for="exampleFormControlInput1" class="form-label"><b>Alamat</b><p>Isikan alamat lahan parkir
                        Anda di bawah sini</p></label>
                      ...
                      <a href=" /Vendor/Kelola-Kendaraan/layanan_step2"><button type="button" class="btn btn-success col-md-12 mt-3">Selanjutnya</button></a>
                </form>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a href="/Vendor/Kelola-Kendaraan/atur_alamat"  class="btn btn-success col-sm-12">Simpan</a>
        </div>
      </div>
    </div>
  </div>       
