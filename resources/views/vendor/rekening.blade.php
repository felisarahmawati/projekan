                    ...
                    <div class="details3">
                        <div class="recentOrders3">
                            <div class="rincian d-inline mb-2">
                                <button type="button"class="btn btn-success float-end" style="border-radius: 10px;" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="bi bi-plus" style="font-size:20px"></i>Tambah Rek. Baru</button>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                  <div class="card" style="border-radius: 30px;"  data-bs-toggle="modal" data-bs-target="#exampleModal2">
                                    <div class="card-body">
                                        <div class="row ">
                                            <div class="col-md-4">
                                              <img src="../../assets/img/mandiri.png" class="img-fluid rounded-start mt-5" alt="..." style="padding-left:15px">
                                            ...
                                            <div class="col-md-8">
                                              <div class="card-body" >
                                            <p>D**A T*****I</p>
                                             <p style="font-size: 15px"><b>BCA</b> <span class="badge rounded-pill bg-danger">
                                                utama
                                             </span></p>
                                             <p>35363463245</p>
                                              </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content" style="width: 700px">
        ...
        <div class="modal-body">
            <div>
                <div class="row mb-3">
                    <label for="colFormLabel" class="col-sm-3 col-form-label" style="font-size:15px">Pilih Bank</label>
                    <div class="col-sm-9">
                        <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg size 3 select example">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Ketikan nomor rekening anda">
                      </div>
            </div>
          </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal1">Cek rekening</button>
        </div>
      </div>
    </div>
  </div>
...
<div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content" style="width: 700px">
        ...
        <div class="text-end">
        <a href="/vendor/rekening"> <button type="button" class="btn btn-success md-4">Simpan</button></a>
        </div>
      </div>
    </div>
  </div>
