...
<div class="container mt-4 mb-4">
    <div class="row row-cols-1 row-cols-md-2 g-4">
        <div class="col" style="width: 400px">
            ...
            <div class="row">
                <div class="col-md">
                    <p  style="color:rgb(85, 182, 91)"><i class="bi bi-question-circle px-1" style="color:rgb(85, 182, 91)"></i>Kebijakan Privasi</p>
                </div>
                <div class="col-md-3">
        ...
        <div class="col" style="width: 700px">
         <div class="card">
            <div class="card-body">
              ...
              <h5 class="card-title"><i class="bi bi-chevron-left px-2 "></i>Kebijakan  privasi</h5>
              <hr width="100%" color="#c0c0c0">
