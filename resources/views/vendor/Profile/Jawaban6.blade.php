...
<div class="container mt-4 mb-4">
    ...
    <div class="row row-cols-1 row-cols-md-2 g-4">
            ...
            <div class="row ">
                <div class="col-md-12">
                    <div class="card" style="background-color: #fff;">
                        ...
                        <div class="card mt-2">
                            <div class="card-body">
                               <p> <a href="/Vendor/Profile/Jawaban6"></a>Mengapa saya tidak mendapatkan
                                notifikasi penarikan?</p>
                            </div>
                        </div>
                        <br>
        ...
        <div class="col" style="width: 700px">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title"><i class="bi bi-arrow-left px-2 "></i>Mengapa saya tidak mendapatkan
                notifikasi penarikan?</h5>
