...
<section class="home-section">
    ...
    <div class="p-5 container card" style="width: 90%" >  
      <a href="/Vendor/Kelola-Bangunan/layanan_step1 " ><button class="btn btn-success p-2  " style="font-size: 20px"><i  class="bi bi-plus"></i>Tambah layanan</button></a> 
      <div class="details1 ">
            ...
            <table class="table-borderless mt-3 w-auto">
                ...
                <tbody class="text-start">
                    ...
                    <tr>
                        <td><img src="" alt=""></td>
                        <td>Apartement</td>
                        <td>Rp20.000/m</td>  <td class="col-md-2">
                            <a href="" class="btn btn-info "data-bs-toggle="modal" data-bs-target="#exampleModal1"><i class="bi bi-info-circle"></i><a>
                            <a href="" class="btn btn-success " data-bs-toggle="modal" data-bs-target="#exampleModal"> <i class="bi bi-pencil-square"></i></a>
                            <a href="" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#Modal"><i class="bi bi-trash"></i></a>
                        </td>
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div>
                                    <a href=" /Vendor/Kelola-Bangunan/setelah_input"><button type="button" class="btn btn-outline-success col-md-12 mt-3">Save</button></a>       
                                 </div>
                                </div>
                                </div>
                              </div>
