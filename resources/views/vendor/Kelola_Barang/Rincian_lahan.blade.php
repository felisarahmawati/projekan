...
<section class="align-items-center services section-bg"  id="services" style="padding-top: 100px;" data-aos-delay="50">
    ...
    <div class="row row-cols-1 row-cols-md-2 g-4">
                            ...
                            <div class="card" style="background-color: #fff;">
                                <div class="card-body">
                                    ...
                                    <form action="" method="GET" enctype="multipart/form-data" class="mb-5">
                                        @csrf
                                            <label class="form-label"><b>Kelola Barang</b></label><hr>
                                            ...
                                            <p><b>Tambah layanan penitipan barang!</b>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        <p class="ps-3">Untuk mengatur lokasi dan detail alamat gudang Anda</p>
                                                    </div>
                                                    <div class="col-lg-2">
                                                ...
                                                <div>
                                                 ...
                                                 <div class="row ">
                                                    <div class="col-md-10 ">
                                                        <p class="ps-3">Mengatur jenis barang yang dititipkan</p>
                                                    </div>
                                                    <div class="col-md-2 ">
                                                        <i class="bi bi-check2-square" style="font-size: 37px; color:text-success;"></i>
                                                ...
                                                <div class="">
                                                 ...
                                                 <div class="row">
                                                    <div class="col-md-9 ">
                                                        <p class="ps-3">Menginputkan detail rincian kondisi gudang</p>
                                                    </div>
                                                    <div class="col-md-1">
        ...
        <div class="col" style="width: 700px">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title"><i class="bi bi-arrow-left px-2 "></i>Rincian lahan</h5>
