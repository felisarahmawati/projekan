...
<section class="home-section">
    ...
    <div class="p-5 container card" style="width: 70%" >    
              ...
              <div class="modal-content">
                ...
                <div class="row">
                  <div class="col-md-6">
                      ...
                      <label class="avatar form-check-label" for="flexCheckDefault" data-bs-toggle="tooltip" data-bs-placement="top" title="isi : Kulkas, lemari, kasur,
     1 set kursi dan meja">
                    ...
                    <div class="form-check" >
                      <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                      <label class="form-check-label" for="flexCheckDefault" data-bs-toggle="tooltip" data-bs-placement="top" title="isi : Kulkas, lemari, kasur,
     1 set kursi dan meja">
                      Paket Barang 2
                      </label>
                    </div>
    ...
    1 set kursi dan meja">
     ...
     1 set kursi dan meja">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                    <label class="form-check-label" for="flexCheckDefault" data-bs-toggle="tooltip" data-bs-placement="top" title="isi : 
     Kulkas, lemari, kasur,1 set kursi dan meja">
               ...
               <div class="col-sm-12">
                <a href="" class="btn btn-success col-md-12 " data-bs-toggle="modal" data-bs-target="#exampleModal2">Ajukan Paket Baru</a>
                <a href="/Vendor/Kelola_Barang/layanan_step3"><button type="button" class="btn btn-success col-md-12 mt-3">Lanjutkan</button><br><br></a> 
              </div>
                </div>
              </div>
            ...
            <div class="modal-content bg-light p-2 text-dark bg-opacity-30">
              ...
              <div class="modal-body">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Paket jumbo">
               </div>
               <div class="mb-3">
                <label for="">Deskripsi/ Isi paket Anda</label>
                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder=" Lemari, tas, baju">
              </div>
              <div class="mb-3">
                <label for="">Harga paket</label>
                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder=" 50.000">
             </div>
             <div class="mb-1">
              <label for="">Deskripsi Layanan </label>
              <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="">
             ...
             <button class="col-md-12 btn btn-success"  data-bs-toggle="modal" data-bs-target="#exampleModal">Ajukan</button>
              </div>
            </div>
          </div>
        ...
        <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content bg-light p-2 text-white bg-opacity-50">
              ...
              <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal"> Kembali</button>
            </div>
          </div>
        </div>  
