        ...
        <div class="row justify-content-center">
            <div class="card" style="background-color: #fff; width:70% ">
                <div class="card-body">
                    ...
                    <a href="/Vendor/Kelola_Barang/layanan_atep2"><i class="bi bi-arrow-left px-2 "></i><b>Kelola Barang</b><hr></a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <i class="bi bi-check2-square text-end" style="font-size: 37px; color:rgb(98, 212, 133);"></i>
                                    ...
                                    <div class="">
                                     ...
                                     <div class="row ">
                                        ...
                                        <div class="col-md-2 mb-3">
                                           <a href="/Vendor/Kelola_Barang/Rincian_lahan"><button class="btn btn-success mb-3">Tambah</button></a>
                                        </div>   
