...
<section class="align-items-center services section-bg"  id="services" style="padding-top: 100px;" data-aos-delay="50">
    ...
    <div class="p-5 container card" style="width: 70%" >    
        <div class="card mt-2">
            <h5 class="card-header bg-success text-white">Detail kelola barang</h5>
            <div class="card-body">
                    ...
                    <div class="row g-0">
                      <div class="col-md-auto">
                        ...
                        <div class="card-body">
                            ...
                            <h5><i class="bi bi-cart-fill p-2" style="font-size: 25px; color:  #ce4c15;"></i><b>Jenis barang</b></h5>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-3 ">
                                        <p>Barang </p>
                ...
                <h5><i class="bi bi-house p-2" style="font-size: 25px; color:  #ce4c15;"></i><b>Kapasitas lahan</b></h5>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <p>Luas lahan </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-auto">
                            <p class="text-end">: Sekitar 50 barang</p>
                        </div>   
                      </div>
                  </div>
                  ...
                  <a href="#" class="btn btn-outline-success  col-md-2" data-bs-toggle="modal" data-bs-target="#exampleModal">Edit</a>
                    ...
                    <div class="card-body">
                        <div class="mb-3" style="max-width: auto;">
                            <div class="row g-0">
                              <div class="col-md-auto">
                                <h5><i class="bi bi-geo-fill p-2" style="font-size: 5px; color: #ce4c15;"></i><b>Alamat Gudang</b></h5>
                                <div class="card-body">
                                    <p class="card-text">Karangjambe, Gg Arjuna No.59, Jaranan,Banguntapan, kec.Banguntapan, Bantul, Daerah Istimewa Yogyakarta 55198</p>
                               
                                  </div>
                        </div>   
                                    <h5><i class="bi bi-cart-fill p-2" style="font-size: 25px; color: #fd7e14;"></i><b>Jenis barang</b></h5>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-3 ">
                                                <p>Barang </p>
                        ...
                        <h5><i class="bi bi-house p-2" style="font-size: 25px; color: #fd7e14;"></i><b>Kapasitas lahan</b></h5>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3">
                                    <p>Luas lahan </p>
                        ...
                        <a href="/Vendor/Kelola_Barang/layanan_step1"><button class="col-sm-12 btn btn-outline-success mt-5">Tambah Layanan</button></a>
                        </div>
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                        ...
                                        <form action="">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8">
                                                            ...
                                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Kapasitas sekitar 50 barang"></textarea>
                                                     </div>
                                ...
                                <div>
                                <h3 style="color:  #999">Kapasitas lahan</h3>
                                    <div class="row">
                                        <div class="mb-3">
                                            <label for="exampleFormControlInput1" class="form-label">luas lahan</label>
                                            <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="50m x 50m">
                                        </div>
