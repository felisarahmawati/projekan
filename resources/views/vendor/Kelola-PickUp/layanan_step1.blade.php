...
<section class="align-items-center  services section-bg"  id="services" style="padding-top: 100px;" data-aos-delay="50">
    <div class="">
        <div class="cardBox1">
            <div class="card1">
                <div>
                    <a href="/Vendor/Kelola-Kendaraan/kelola_barang" style="text-decoration:none">
                            ...
                            <div class="card" style="background-color: #fff;">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <a href="/Vendor/Kelola-PickUp/atur_alamat"><button class="btn btn-success mb-3">Tambah</button></a>
