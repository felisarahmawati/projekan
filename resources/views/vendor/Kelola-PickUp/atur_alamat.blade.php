                        ...
                        <div class="col-md-12">
                            <div class="card" style="background-color: #fff;">
                                ...
                                <form action="" method="get" enctype="multipart/form-data" class="mb-5">
                                    ...
                                    <label for="faq" class="form-label"><i class="bi bi-arrow-left px-2 "></i><b>Kelola Pickup</b></label><hr>
                                    ...
                                    <div>
                                     ...
                                     <div class="row text-muted">
                                        <div class="col-md-8 ">
                                            <p class="">Mengatur jenis dan jumlah
                                                kendaraan yang akan beroperasi.</p>
                                        </div>
