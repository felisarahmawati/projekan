                                ...
                                <div class="card-body">
                                    ...
                                    <div class="">
                                     ...
                                     <div class="row">
                                        <div class="col-md-10 ">
                                            <p class="ps-4">
                                                Mengatur jenis dan jumlah
                                                kendaraan yang akan beroperasi.
                                            </p>
                                        </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <div class="mb-3">
              <label for="exampleFormControlInput1" class="form-label"><b>Pilih kendaraan yang anda
                sediakan</b>
        ...
        <div class="col-md-12">
            <label for="exampleFormControlInput1" class="form-label mb-2"><b>Kendaraan yang beroperasi.</b></label>
            <P class="text-muted">Masukkan total jumlah kendaraan yang
                akan beroperasi. </P>
