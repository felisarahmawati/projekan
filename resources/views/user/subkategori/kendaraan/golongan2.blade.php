                    ...
                    <div class="row row-cols-1 row-cols-md-2 g-4">
                        <div class="col" style="width: 400px">
                            ...
                            <div class="col" style="width: 700px">
                                <p class="card-title text-success mt-4" style="font-size: 20px"><b>Kendaraan golongan 2</b></p>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="card" style="width: 13.5rem;">
                                                    
                                                    <a href="/user/kategori/kendaraan/detail_layanan"><img src="{{ asset('assets/img/paj.png') }}" class="card-img-top" alt="..."></a>
                                                    <div class="card-body">

                                                        <div class="row">
                                                            <div class="col">
                                                                <a href="/user/kategori/kendaraan/detail_layanan"><p class="card-title"><b>Wijaya mobil</b></p></a>
                                                            </div>
                                                            <div class="col-2">
                                            ...
                                            <div class="col-4">
                                                <div class="card" style="width: 13.5rem">
                                                    ...
                                                    <a href="#"><img src="{{ asset('assets/img/paj.png') }}" class="card-img-top" alt="..."></a>
                                                    <div class="card-body">
