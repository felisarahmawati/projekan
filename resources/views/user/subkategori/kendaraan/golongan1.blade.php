                                        ...
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="card" style="width: 13.5rem;">
                                                    ...
                                                    <a href="/user/subkategori/kendaraan/detail_kendaraan"><img src="{{ asset('assets/img/z.png') }}" class="card-img-top" alt="..."></a>
                                                    <div class="card-body">

                                                        <div class="row">
                                                            <div class="col">
                                                                <a href="/user/subkategori/kendaraan/detail_kendaraan"><p class="card-title"><b>Wijaya motor</b></p></a>
                                                            </div>
                                                            <div class="col-2">
