                        ...
                        <div class=" mt-3 mb-3" style="max-width: 100%;">
                            <div class="row g-0">
                                <div class="col-md-6 mt-3" style="padding-top: 50px">
                                    <img src="{{ asset('assets/img/jam.png') }}" class="img-fluid rounded-start" alt="...">
                                </div>
                                <div class="col-md-6">
                                    <div class="card-body">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="d-grid gap-2 col-6 mx-auto">
                                                {{-- <a class="btn btn-outline-secondary" href="/user/kategori/kendaraan/wishlist" role="button">Wishlist</a> --}}
                                            ...
                                            <div class="d-grid gap-2 col-6 mx-auto">
                                                <a class="btn btn-outline-success" href="/user/pemesanan/pesanan/pesanan_barang" role="button">Langsung order</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="">
                            <div class="card-body">
                                ...
                                <div class="col-12 text-muted">
                                    <p>
                                        Gudang garam merupakan jasa penitipan barang dengan gudang terbersih di Yogyakarta. Akan kami
                                        jamin keamanan barang anda, dengan fasilitas dan lahan yang kami punya. Kepercayaan anda adalah kepuasan kami
                                    </p>
                                </div>
                            </div>
                        </div>
