                    ...
                    <div class="row row-cols-1 row-cols-md-2 g-4">
                        <div class="col" style="width: 400px">
                            ...
                            <div class="col" style="width: 700px">
                                <p class="card-title text-success mt-4" style="font-size: 20px"><b>Paket</b></p>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="card" style="width: 13.5rem;">
                                                    
                                                    <a href="/user/subkategori/barang/detail_paket"><img src="{{ asset('assets/img/paket.png') }}" class="card-img-top" alt="..."></a>
                                                    <div class="card-body">

                                                        <div class="row">
                                                            <div class="col">
                                                                <a href="/user/subkategori/barang/detail_paket"><p class="card-title"><b>Gudang garam</b></p></a>
                                                            </div>
                                                            <div class="col-2">
                                                                <h5><i class="bi bi-suit-heart"></i></h5>
                                                            </div>
                                                            <p class="text-success" style="font-size: 14px; margin-bottom: 10px">
                                                                <b>IDR 30.000 - 100.000 / hari</b>
                                                            </p> 
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="alamat">
                                                                    <p style="font-size: 13px">Kab. Sleman, Yogyakarta</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-4">
                                                <div class="card" style="width: 13.5rem;">
                                                    ...
                                                    <a href="/user/kategori/barang/detail_coba"><img src="{{ asset('assets/img/paket.png') }}" class="card-img-top" alt="..."></a>
                                                    <div class="card-body">

                                                        <div class="row">
                                                            <div class="col">
                                                                <a href="/user/kategori/barang/detail_coba"><p class="card-title"><b>Gudang gula</b></p></a>
                                                            </div>
                                                            <div class="col-2">
                                                                <h5><i class="bi bi-suit-heart"></i></h5>
                                                            </div>
                                                            <p class="text-success" style="font-size: 14px; margin-bottom: 10px">
                                                                <b>IDR 25.000 - 100.000 / hari</b>
                                                            </p> 
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="alamat">
                                                                    <p style="font-size: 13px">Kab. Bantul, Yogyakarta</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-4">
                                                <div class="card" style="width: 13.5rem;">
                                                    ...
                                                    <a href="/user/kategori/bangunan/detail_bangunan"><img src="{{ asset('assets/img/paket.png') }}" class="card-img-top" alt="..."></a>
                                                    <div class="card-body">

                                                        <div class="row">
                                                            <div class="col">
                                                                <a href="/user/kategori/bangunan/detail_bangunan"><p class="card-title"><b>Gudang Titip</b></p></a>
                                                            </div>
                                                            <div class="col-2">
                                                                <h5><i class="bi bi-suit-heart"></i></h5>
                                                            </div>
                                                            <p class="text-success" style="font-size: 14px; margin-bottom: 10px">
                                                                <b>IDR 35.000 - 100.000 / hari</b>
                                                            </p> 
                                                        </div>
                                            ...
                                            <div class="col-4 mt-2">
                                                <div class="card" style="width: 13.5rem;">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <a href="/user/kategori/bangunan/detail_bangunan"><p class="card-title"><b>Gudang gula</b></p></a>
                                                            </div>
                                                            <div class="col-2">
                                                                <h5><i class="bi bi-suit-heart"></i></h5>
                                                            </div>
