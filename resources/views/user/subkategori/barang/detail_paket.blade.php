                ...
                <div class="card">
                    ...
                    <div class="container">
                        <div class=" mt-3 mb-3" style="max-width: 100%;">
                            <div class="row g-0">
                                <div class="col-md-6">
                                    <img src="{{ asset('assets/img/paket.png') }}" class="img-fluid rounded-start" alt="...">
                                </div>
                                <div class="col-md-6">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-7">
                                                <p class="mb-2" style="font-size: 23px; margin-bottom: 10px">
                                                    <b>Titip paket | Malioboro vendor</b>
                                                </p>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="d-grid gap-2 col-6 mx-auto">
                                                <a class="btn btn-outline-success" href="/user/pemesanan/pesanan/pesanan_paket" role="button">Langsung order</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="">
                            <div class="card-body">
                                ...
                                <div class="col-12 text-muted">
                                    <p>
                                        Penitipan paket Malioboro merupakan salah satu jasa penitipan paket terbaik di Yogyakarta,
                                        yang melayani penitipan paket barang-barang untuk anak kos yang mungkin males bawa barang banyak pas mudik. 
                                        Atau untuk keluarga yang mau nitipin paket barang-barang di apartementnya atau pun di rumah bahkan di kamar putra-putrinya.
                                        Nah titip paket Malioboro ini cocok untuk kebutuhan anda dalam penitipan,kami akan jamin keamanan paket anda.
                                        Dengan gudang terbaik terbersih yang kami punya. 
                                    </p>
                                </div>
                            </div>
                        </div>
