                    ...
                    <div class="row row-cols-1 row-cols-md-2 g-4">
                        <div class="col" style="width: 400px">
                            ...
                            <div class="col" style="width: 700px">
                                <p class="card-title text-success mt-4" style="font-size: 20px"><b>Apartement</b></p>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="card" style="width: 13.5rem;">
                                                    
                                                    <a href="/user/subkategori/bangunan/detail_bangunan"><img src="{{ asset('assets/img/Apartemen.jpg') }}" class="card-img-top" alt="..."></a>
                                                    <div class="card-body">

                                                        <div class="row">
                                                            <div class="col">
                                                                <a href="/user/subkategori/bangunan/detail_bangunan"><p class="card-title"><b>Titip Apart</b></p></a>
                                                            </div>
                                                            <div class="col-2">
                                                                <h5><i class="bi bi-suit-heart"></i></h5>
                                                            </div>
                                                            <p class="text-success" style="font-size: 14px; margin-bottom: 10px">
                                                                <b>IDR 50.000 / meter</b>
                                                            </p> 
                                                        </div>
                                            ...
                                            <div class="col-4">
                                                <div class="card" style="width: 13.5rem">
                                                    ...
                                                    <a href="#"><img src="{{ asset('assets/img/Apartemen.jpg') }}" class="card-img-top" alt="..."></a>
                                                    <div class="card-body">
