                    ...
                    <div class="row row-cols-1 row-cols-md-2 g-4">
                        <div class="col" style="width: 400px">
                            ...
                            <div class="col" style="width: 700px">
                                <p class="card-title text-success mt-4" style="font-size: 20px"><b>Kontrakan</b></p>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="card" style="width: 13.5rem;">
                                                    
                                                    <a href="/user/subkategori/bangunan/detail_bangunan"><img src="{{ asset('assets/img/kontrakan.jpg') }}" class="card-img-top" alt="..."></a>
                                                    <div class="card-body">

                                                        <div class="row">
                                                            <div class="col">
                                                                <a href="/user/subkategori/bangunan/detail_bangunan"><p class="card-title"><b>Titip ya | titipsini</b></p></a>
                                                            </div>
                                                            <div class="col-2">
                                                                <h5><i class="bi bi-suit-heart"></i></h5>
                                                            </div>
                                                            <p class="text-success" style="font-size: 14px; margin-bottom: 10px">
                                                                <b>IDR 30.000 / meter</b>
                                                            </p> 
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="alamat">
                                                                    <p style="font-size: 13px">Jln. Laksda Adisucipto (4 km)</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-4">
                                                <div class="card" style="width: 13.5rem">
                                                    ...
                                                    <a href="#"><img src="{{ asset('assets/img/kontrakan.jpg') }}" class="card-img-top" alt="..."></a>
                                                    <div class="card-body">

                                                        <div class="row">
                                                            <div class="col">
                                                                <a href="#"><p class="card-title"><b>Blessing Room</b></p></a>
                                                            </div>
                                                            <div class="col-2">
                                                                <h5><i class="bi bi-suit-heart"></i></h5>
                                                            </div>
                                                            <p class="text-success" style="font-size: 14px; margin-bottom: 10px">
                                                                <b>IDR 95.000 - 150.000 / hari</b>
                                                            </p> 
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="alamat">
                                                                    <p style="font-size: 13px">Jln. Seturan Raya (13 km)</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-4">
                                                <div class="card" style="width: 13.5rem">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <a href="#"><p class="card-title"><b>Green Park</b></p></a>
                                                            </div>
                                                            <div class="col-2">
                                                                <h5><i class="bi bi-suit-heart"></i></h5>
                                                            </div>
                                                            <p class="text-success" style="font-size: 14px; margin-bottom: 10px">
                                                                <b>IDR 95.000 - 200.000 / hari</b>
                                                            </p> 
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="alamat">
                                                                    <p style="font-size: 13px">Jln. Tambak bayan. Babarsari</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-4 mt-2">
                                                <div class="card" style="width: 13.5rem;">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <a href="#"><p class="card-title"><b>Malioboro City</b></p></a>
                                                            </div>
                                                            <div class="col-2">
                                                                <h5><i class="bi bi-suit-heart"></i></h5>
                                                            </div>
                                                            <p class="text-success" style="font-size: 14px; margin-bottom: 10px">
                                                                <b>IDR 80.000 - 150.000 / hari</b>
                                                            </p> 
                                                        </div>
