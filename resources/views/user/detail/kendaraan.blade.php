                    ...
                    <div class="col-md-6 mt-4 pe-10 ps-2 mb-1 container">
                        <div class="card-layanan d-flex flex-column px-0 py-4">
                            <div class="id-layanan px-3">
                                <h6 class="mb-1 fw-bold text-center"><b>Layanan Kendaraan</b></h6>
                            </div>
                            <hr width="100%" color="#c0c0c0">
                            <div class="col-md-20">
                                <label for="inputKendaraan" class="form-label"><b>Kendaraan</b></label>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <label for="Quantity"><b>Kendaraan</b></label>
