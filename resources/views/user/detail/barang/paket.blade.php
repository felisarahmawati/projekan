    ...
    <section id="services" class="services section-bg" style="padding-top: 100px;">
        <div class="container detail_layanan" data-aos="fade-up">
            ...
            <div class="container-fluid">
                ...
                <div class="row g-3" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000">
                    ...
                    <div class="col-md-6 mt-4 pe-10 ps-2 mb-1 container">
                        <div class="card-layanan d-flex flex-column px-0 py-4">
                            <div class="id-layanan px-3">
                                <h6 class="mb-1 fw-bold text-center"><b>Layanan Paket</b></h6>
                            </div>
                            <hr width="100%" color="#c0c0c0">
                            <div class="col-md-20">
                                <label for="inputKendaraan" class="form-label"><b>Paket</b></label><br>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="option1">
                                    <label class="form-check-label" for="inlineCheckbox1">Kamar Kos</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="option1">
                                    <label class="form-check-label" for="inlineCheckbox1">Nanas Spongebob</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="option2">
                                    <label class="form-check-label" for="inlineCheckbox2">Rumah</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="option2">
                                    <label class="form-check-label" for="inlineCheckbox3">Apartemen</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-20" style="padding-top: 10px;">
                                    <label for="Quantity"><b>Barang</b></label>
                            ...
                            <div class="mb-3" style="padding-top: 10px;">
                                ...
                                <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="14-08-2022">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label"><b>Tanggal Keluar</b></label>
                                <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="05-03-2022">
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="input-group mb-3" style="width: 320%">
                                        ...
                                        <input type="text" class="form-control bg-white" placeholder="Catatan" name="kosan">
                                    </div>
                                </div>
                            </div>
